...
# Keep the loader as plain-text JS and ship the wasm as a separate asset.
# This avoids publishing binary bytes inside the ESM wrapper, which is
# fragile for Vite/esbuild/Rolldown dependency scanning.
emcc \
